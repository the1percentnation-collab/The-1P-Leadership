    ...
    <div class="cl-hero">
      <div class="cl-hero-inner">
        <div class="cl-hero-main">
          ...
          <div class="cl-meta">
            <span>Created by <a href="https://the1pnation.com" target="_blank" rel="noopener">${escapeHtml(INSTRUCTOR.name)}</a></span>
...
async function main() {
  ...
  document.title = `${course.title} | The One Percent Academy`;
